        ...
        <header>
          ...
          <section className="instructions">
            <p>
              ...
              history to export them. The images can be added to the queue one
              by one or multiple at a time until you press the scan button. The
            ...
            <p>
              ...
              upload batch will be discarded. Please open an issue on github
